...
import { checkingListChecklistAPI } from "../../api";

interface CheckingListChecklistProps {
  onLogout: () => void;
  onBack: () => void;
  onNext?: () => void;
...
export function CheckingListChecklist({
  onLogout,
  onBack,
  onNext,
  initialHanger,
}: CheckingListChecklistProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await checkingListChecklistAPI.save(
        selectedHanger!,
        checklistPayload,
        doneBy,
        doneOn
      ...
      alert(err.message || "Failed to submit checking list");
    } finally {
