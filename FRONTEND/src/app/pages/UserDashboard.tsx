...
export function UserDashboard({
  ...
  const cards = [
    {
      id: "hanger-servicing" as const,
      title: "Hanger Servicing",
      icon: Wrench,
      color: "from-[#0b5d3b] to-[#0a4d30]",
    },
    {
      id: "barcode-replacement" as const,
      title: "Barcode Reader Replacement",
      icon: Barcode,
      color: "from-gray-700 to-gray-900",
    },
    {
      id: "wheel-replacement" as const,
      title: "Wheel Replacement",
      icon: CircleDot,
      color: "from-[#0b5d3b] to-[#074d2c]",
    },
    {
      id: "checking-list" as const,
      title: "Checking List",
      icon: ClipboardCheck,
