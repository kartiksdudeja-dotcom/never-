...
interface HangerServicingProps {
  onLogout: () => void;
  onNext: () => void;
  onBack: () => void;
  onHangerClick?: (hangerNo: number) => void;
  onStartServiceChecklist?: () => void;
...
export function HangerServicing({
  onLogout,
  onNext,
  onBack,
  onHangerClick,
  onStartServiceChecklist,
  submissionTrigger,
}: HangerServicingProps) {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      console.error("Failed to fetch hanger data:", err);
      ...
      >
        ...
        <div className="text-center mb-6 md:mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-800">
            Hanger Servicing Completion Status
          </h1>
          <button
            onClick={onBack}
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center md:justify-between max-w-6xl mx-auto">
          <motion.button
            ...
            onClick={onStartServiceChecklist}
